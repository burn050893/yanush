...
export const dict = {
  nl: {
    ...
    home: { latest: 'Nieuwste Auto\'s', latestSub: 'Onze recent toegevoegde voertuigen', viewAll: 'Bekijk alle auto\'s', services: 'Onze Diensten', servicesSub: 'Volledige service van A tot Z' },
  ...
  fr: {
    ...
    home: { latest: 'Nouveautés', latestSub: 'Nos véhicules récemment ajoutés', viewAll: 'Voir toutes les voitures', services: 'Nos Services', servicesSub: 'Service complet de A à Z' },
  ...
  en: {
    ...
    home: { latest: 'Latest Arrivals', latestSub: 'Our recently added vehicles', viewAll: 'View all cars', services: 'Our Services', servicesSub: 'Complete service from A to Z' },
  ...
  tr: {
    ...
    home: { latest: 'Yeni Gelenler', latestSub: 'En son eklenen araçlarımız', viewAll: 'Tüm araçlar', services: 'Hizmetlerimiz', servicesSub: 'A\'dan Z\'ye tam hizmet' },
  ...
  bg: {
    ...
    home: { latest: 'Най-нови', latestSub: 'Нашите наскоро добавени автомобили', viewAll: 'Виж всички', services: 'Нашите услуги', servicesSub: 'Пълно обслужване от А до Я' },
