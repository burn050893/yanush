...
export const dict = {
  nl: {
    ...
    about: {
      ...
      p1: 'Wij zijn een Belgische autohandel gespecialiseerd in de aan- en verkoop van kwaliteitsvolle tweedehands voertuigen. Met meer dan 5 jaar ervaring in de sector staan wij garant voor transparantie, eerlijk advies en een zorgvuldige selectie van elk voertuig.',
      ...
      st1t: '5+ Jaar Ervaring', st1d: 'Actief in de Belgische tweedehandsmarkt met sterke vakkennis.',
  ...
  fr: {
    ...
    about: {
      ...
      p1: 'Nous sommes un concessionnaire belge spécialisé dans l\'achat et la vente de véhicules d\'occasion de qualité. Forts de plus de 5 ans d\'expérience dans le secteur, nous incarnons la transparence, le conseil sincère et une sélection rigoureuse pour chaque véhicule.',
      ...
      st1t: '5+ Ans d\'Expérience', st1d: 'Actif sur le marché belge de l\'occasion avec un véritable savoir-faire.',
      ...
      stat1v: '5+', stat1l: 'Ans d\'Expérience',
  ...
  en: {
    ...
    about: {
      ...
      p1: 'We are a Belgian dealership specialised in buying and selling quality pre-owned vehicles. With over 5 years of industry experience, we stand for transparency, honest advice and a carefully curated selection of every car.',
      ...
      st1t: '5+ Years Experience', st1d: 'Active in the Belgian pre-owned market with strong industry know-how.',
      ...
      stat1v: '5+', stat1l: 'Years Experience',
  ...
  tr: {
    ...
    about: {
      ...
      p1: 'Kaliteli ikinci el araçların alım ve satımında uzmanlaşmış bir Belçika otomotiv firmasıyız. Sektördeki 5+ yıllık deneyimimizle şeffaflık, dürüst tavsiye ve özenle seçilmiş bir araç yelpazesi sunuyoruz.',
      ...
      st1t: '5+ Yıl Deneyim', st1d: 'Belçika ikinci el pazarında köklü uzmanlık ve sektör bilgisi.',
  ...
  bg: {
    ...
    about: {
      ...
      p1: 'Ние сме белгийска автокъща, специализирана в покупко-продажбата на качествени употребявани автомобили. С над 5 години опит в сектора, ние гарантираме прозрачност, честен съвет и внимателно подбран автопарк за всеки клиент.',
      ...
      st1t: '5+ Години Опит', st1d: 'Активно присъствие на белгийския пазар с задълбочена експертиза.',
