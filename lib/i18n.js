...
export const dict = {
  nl: {
    ...
    home: { latest: 'Nieuwste Auto\'s', latestSub: 'Onze recent toegevoegde premium voertuigen', viewAll: 'Bekijk alle auto\'s', services: 'Onze Diensten', servicesSub: 'Volledige service van A tot Z' },
    ...
    services: { title: 'Onze Services', subtitle: 'Volledige automotive service', s1: 'Belgische Keuring', s1d: 'Periodieke keuring en verkoopkeuring', s2: 'Takeldienst', s2d: '24/7 takeldienst op aanvraag', s3: 'Pechhulp', s3d: 'Snelle interventie bij pech', s4: 'Transport', s4d: 'Veilig autotransport in heel België' },
  ...
  fr: {
    ...
    home: { latest: 'Nouveautés', latestSub: 'Nos véhicules premium récemment ajoutés', viewAll: 'Voir toutes les voitures', services: 'Nos Services', servicesSub: 'Service complet de A à Z' },
    ...
    services: { title: 'Nos Services', subtitle: 'Service automobile complet', s1: 'Contrôle Technique', s1d: 'Contrôle périodique et de vente', s2: 'Dépannage', s2d: 'Service de remorquage 24/7', s3: 'Assistance', s3d: 'Intervention rapide en panne', s4: 'Transport', s4d: 'Transport sécurisé en Belgique' },
  ...
  en: {
    ...
    home: { latest: 'Latest Arrivals', latestSub: 'Our recently added premium vehicles', viewAll: 'View all cars', services: 'Our Services', servicesSub: 'Complete service from A to Z' },
    ...
    services: { title: 'Our Services', subtitle: 'Full automotive service', s1: 'Belgian Inspection', s1d: 'Periodic and sale inspections', s2: 'Towing Service', s2d: '24/7 towing on demand', s3: 'Roadside Assistance', s3d: 'Quick breakdown response', s4: 'Transport', s4d: 'Safe vehicle transport in Belgium' },
  ...
  tr: {
    ...
    hero: { title: 'YANUSH Cars', subtitle: 'Premium duruş, herkes için ulaşılabilir', tagline: 'İkinci el araçlarda güvenilir ortağınız.', cta1: 'Filomuz', cta2: 'Hakkımızda', cta3: 'İletişim' },
    home: { latest: 'Yeni Gelenler', latestSub: 'En son eklenen premium araçlarımız', viewAll: 'Tüm araçlar', services: 'Hizmetlerimiz', servicesSub: 'A\'dan Z\'ye tam hizmet' },
    ...
    services: { title: 'Hizmetlerimiz', subtitle: 'Tam otomotiv hizmeti', s1: 'Belçika Muayene', s1d: 'Periyodik ve satış muayenesi', s2: 'Çekici', s2d: '24/7 çekici hizmeti', s3: 'Yol Yardım', s3d: 'Hızlı arıza müdahalesi', s4: 'Transport', s4d: 'Belçika\'da güvenli araç taşıma' },
  ...
  bg: {
    ...
    home: { latest: 'Най-нови', latestSub: 'Нашите наскоро добавени премиум автомобили', viewAll: 'Виж всички', services: 'Нашите услуги', servicesSub: 'Пълно обслужване от А до Я' },
    ...
    services: { title: 'Нашите Услуги', subtitle: 'Пълен автомобилен сервиз', s1: 'Белгийски Технически Преглед', s1d: 'Периодичен и за продажба преглед', s2: 'Пътна Помощ', s2d: '24/7 пътна помощ', s3: 'Аварийна Помощ', s3d: 'Бърза реакция при повреда', s4: 'Транспорт', s4d: 'Безопасен транспорт в Белгия' },
